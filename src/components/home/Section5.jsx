        ...
        <div className="flex  gap-4 lg:gap-8 justify-between">
          ...
          <div className="flex flex-col lg:flex-row bg-white rounded-[8px] w-[262px] lg:w-[556px]">
            ...
            <div className="p-4 lg:p-8 lg:w-3/5">
              ...
              <p className="text-[#333333] text-[14px]">
                We supply premium budded and grafted nutmeg, coconut, mango, and
                fruit plants. Delivered safely to your site, ready for planting
        ...
        <div className="flex gap-4 lg:gap-8 justify-between">
          <div className="flex flex-col lg:flex-row bg-white rounded-[8px] w-[262px] lg:w-[556px]">
            ...
            <div className="p-4 lg:p-8 lg:w-3/5">
              ...
              <p className="text-[#333333] text-[14px]">
                From land clearing to complete plantation setup, drip /
                sprinkler irrigation we manage every step. We ensures proper
                planting and development for a thriving farm or orchard.{" "}
              </p>
              <p className="text-[#2E7D32] text-[14px] font-semibold mt-2">
                Learn More
              </p>
          ...
          <div className="flex flex-col lg:flex-row bg-white rounded-[8px] w-[262px] lg:w-[556px]">
            ...
            <div className="p-4 lg:p-8 lg:w-3/5">
              ...
              <p className="text-[#333333] text-[14px]">
                We provide ongoing care and technical support for your
                plantation. From soil health to pruning, we ensure sustainable
                growth and maximum yield year after year.
              </p>
              <p className="text-[#2E7D32] text-[14px] font-semibold mt-2">
                Learn More
              </p>
